...
# Load the dataset
file_path = r"YOUR_OUM_PATH\1_Clustering\data_risk_Industry.csv"
...
plt.savefig("1_Clustering/graph_spectral_clustering.jpg", dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig("1_Clustering/graph_iris_clustering.jpg", dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig("1_Clustering/graph_umap.jpg", dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig("1_Clustering/graph_tsne.jpg", dpi=300, bbox_inches='tight')
plt.show()
